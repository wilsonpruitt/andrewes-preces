...
**Current front: PART II IN PROGRESS. §§1–10 COMPLETE both layers (printed 267–309top).** Part I is complete end-to-end (printed 1–263). Part II sections done in `part2/`, each transcript + line-keyed English, self-checked parity:
...
**NEXT = §11 Passion meditation (*Pro morte Christi*), begins mid-printed-309 = PDF 332.** Opens "Pro morte Christi, / 1. Obedientia usque ad mortem crucis, / 2. Desiderio ejus coarctante, / Pro iis quæ passus est in { Gethsemane / Gabbatha / Golgotha }" (already read on PDF 332). Runs through the Seven Last Words (~printed 314 per map). Then Transfiguratio + Pro Spiritu Sancto + Triumphus misericordiæ (315–320), etc. Map marks 309–320 "La+Gk" — check layer per page (likely more inline Greek + possibly sustained Greek in the eucharistic stretch). **LESSON (reconfirmed twice this session): section boundaries don't align to page tops — read one page PAST the apparent end before closing a section.** Work down STRUCTURE.md §PARS SECUNDA.

## NEXT ACTION

**Offset is stable +23** through the whole main body (verified this session through 309). Extract with `pdftoppm -jpeg -r 200 -f 332 -l NNN raw/preces1853.pdf raw/end/p`; **printed 309 = PDF 332** (already extracted; §11 opening read — the *Pro morte Christi* block is at the BOTTOM of 332, below §10's end). Re-verify the printed page number by eye every batch (dups resume ~368). Continue the `part2/NN-slug-transcript.md` + `-english.md` file pattern; match the §1–10 files exactly.
