...
**Current front: PART II IN PROGRESS. §§1–7 COMPLETE both layers (printed 267–298).** Part I is complete end-to-end (printed 1–263). Part II sections done in `part2/`, each transcript + line-keyed English, self-checked parity:
...
- **§7 `07-allegatio`** (291–298) — Latin-only six-part forensic plea (I Ex parte Dei … VI consequentis boni), scripture-tag evidence under numbered counts; rendered as advocacy, parity 8/8.

**NEXT = §8 Confessio Laudis (divine attributes), printed 299–302 = PDF 322–325.** ⚠ **The map marks 299 onward as "La+Gk"** — this is the FIRST Part II stretch that may carry a sustained Greek parallel, not just inline glosses. **Check every page which layer(s) it carries** before translating: sustained Greek = main text (translate it in full, keep it apposed); a few inline Greek words = ride inside the Latin (§17). Then Confessio (angelic orders) + Confessio Laudum (303–308), Passion meditation (309–314), etc. — work down STRUCTURE.md §PARS SECUNDA.

## NEXT ACTION

**Offset is stable +23** through the whole main body (verified this session at 274/276/278/280/286/291). Extract with `pdftoppm -jpeg -r 200 -f 322 -l NNN raw/preces1853.pdf raw/end/p`; **printed 299 = PDF 322**. Re-verify the printed page number by eye every batch (dups resume ~368). Continue the `part2/NN-slug-transcript.md` + `-english.md` file pattern; match the §1–7 files exactly (header para + `<!-- printed N (PDF M) -->` markers + `## Translator's flags`).
...
- 2026-07-17 (Opus 4.8, Part II cont.): **Added §7 Allegatio** (printed 291–298), both layers, parity 8/8 — the six-part forensic plea (I–VI), rendered as advocacy; the *opus proprium/alienum* crux and the *Ne deleas/vilipendas/præscindas* plea-directives flagged. §8 Confessio Laudis opens printed 299 (PDF 322) — WATCH the "La+Gk" layer shift (first possible sustained Greek in Part II). NEXT = §8.
