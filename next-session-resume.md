...
**Current front: PART II IN PROGRESS. §§1–8 COMPLETE both layers (printed 267–303top).** Part I is complete end-to-end (printed 1–263). Part II sections done in `part2/`, each transcript + line-keyed English, self-checked parity:
...
**NEXT = §9 Confessio [in angelic orders] + Confessio Laudum, printed 303(mid)–308 = PDF 326(bottom)–331.** Opens "CONFESSIO / in / Angelis, curam hominum agentibus…" mid-303 (already read on PDF 326); the nine angelic orders (Angeli/Archangeli/Virtutes/Potestates/Principatus/Dominationes/Throni…), then Confessio Laudum (creation & Christ's economy). **Map marks this "La+Gk"** — same discipline as §8: check layer per page, translate sustained Greek as main text, keep inline glosses apposed. **LESSON from §7/§8: section boundaries don't align to page tops — always read one page PAST the apparent end to confirm the next caps-title before closing a section.** Then Passion meditation (309–314), etc. — down STRUCTURE.md §PARS SECUNDA.

## NEXT ACTION

**Offset is stable +23** through the whole main body (verified this session through 303). Extract with `pdftoppm -jpeg -r 200 -f 326 -l NNN raw/preces1853.pdf raw/end/p`; **printed 303 = PDF 326** (already extracted; §9 opening read). Re-verify the printed page number by eye every batch (dups resume ~368). Continue the `part2/NN-slug-transcript.md` + `-english.md` file pattern; match the §1–8 files exactly (header para + `<!-- printed N (PDF M) -->` markers + `## Translator's flags`).
