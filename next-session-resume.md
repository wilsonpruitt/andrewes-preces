...
**Current front: PART II IN PROGRESS. §§1–11 COMPLETE both layers (printed 267–315top).** Part I is complete end-to-end (printed 1–263). Part II sections done in `part2/`, each transcript + line-keyed English, self-checked parity:
...
- **§11 `11-pro-morte-christi`** (309foot–315top) — the great Passion meditation. Latin body + parallel/inline Greek (Ὠδῖνες/Αἰσχύνη/Κατάρα τοῦ σταυροῦ 310; ῥαπίσματι 311; Πλάνον / Ἄγνωστοι βάσανοι 314). Structure: Gethsemane · Gabbatha · Golgotha, then the head-to-foot anatomy of suffering under running Roman numerals I–VIII (odd Arabic restarts — transcribed verbatim), the hinge-prayer *Per pœnas Tuas … a pœnis inferni libera*, the **Septem verba Christi novissima** (Seven Last Words, given in AV/BCP form), the five-wounds *ignosce per illud* absolution-plea, and the offering-close *Per hæc omnia … Patri Tuo* / *amaritudines … Charitatem*. Parity 7/7.

**NEXT = §12 *Transfiguratio*, begins mid-printed-315 = PDF 338** (already read this session, foot of 338). Opens "Transfiguratio. / 1. Triumphus et traductio principatuum, et potestatum tenebrarum in seipso. [Col. ii. 15.] / 2. Potens resurrectio. [Phil. iii. 10.] / 3. Apparitio { 1. Magdalenæ [Mar. xvi. 9.] / 2. Mulieribus [Matt. xxviii. 9.] } …" — the Resurrection/Ascension/exaltation cycle. Then (per map) Pro Spiritu Sancto + Triumphus misericordiæ (~315–320). Map marks 309–320 "La+Gk" — check layer per page. **LESSON (reconfirmed 3× now): section boundaries don't align to page tops — read one page PAST the apparent end before closing a section.** Work down STRUCTURE.md §PARS SECUNDA.

## NEXT ACTION

**Offset is stable +23** through the whole main body (verified this session through 315). Extract with `pdftoppm -jpeg -r 200 -f 338 -l NNN raw/preces1853.pdf raw/end/p`; **printed 315 = PDF 338** (already extracted; §12 *Transfiguratio* opening read at the FOOT of 338, below §11's end). Re-verify the printed page number by eye every batch (dups resume ~368). Continue the `part2/NN-slug-transcript.md` + `-english.md` file pattern; match the §1–11 files exactly.
